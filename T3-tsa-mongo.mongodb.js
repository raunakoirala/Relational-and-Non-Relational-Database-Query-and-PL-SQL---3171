...
db.resorts_collection.insertMany([
    {
      "_id": 1,
      "name": "Byron Bay, NSW",
      "location": {
...
db.resorts_collection.updateMany(
  { "resorts.company_name": "Tropical Dream" },
  { $set: { "resorts.$.company_name": "Tropical Heaven" } }
)

db.resorts_collection.find({ "resorts.company_name": "Tropical Heaven" })
...
db.resorts_collection.updateOne(
  { "_id": 7 },
  {
    $push: {
      "resorts": {
...
db.resorts_collection.find({ "_id": 7 })
